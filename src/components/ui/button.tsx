...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive touch-manipulation active:scale-95 select-none",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        default: "h-9 px-4 py-2 has-[>svg]:px-3 min-h-touch",
        sm: "h-8 rounded-md gap-1.5 px-3 has-[>svg]:px-2.5 min-h-[32px]",
        lg: "h-10 rounded-md px-6 has-[>svg]:px-4 min-h-touch",
        icon: "size-9 min-w-touch min-h-touch",
