...
import { handleGameScore, getUserGameInfo, getExperienceSettings } from '../../utils/experience';

const ReactionGame: React.FC = () => {
  const [gameState, setGameState] = useState<'waiting' | 'ready' | 'clicking'>('waiting');
...
const GameArea = styled.div<{ gameState: string }>`
  ...
  background-color: ${props => 
    props.gameState === 'waiting' ? '#4CAF50' :
    props.gameState === 'ready' ? '#FFC107' :
    '#F44336'
  };
  color: white;
  border-radius: 10px;
