      ...
      <Main>
        ...
        <TestNotice>
          ...
          <ol>
            ...
            <li>
              전화번호 인증 과정이 없어 계정도 여러 개 만들 수 있습니다.
              활성화된 커뮤니티처럼 보이는 것이 목표입니다.
            </li>
            <li>
              작성하신 게시글은 구글 검색 결과 상단에 노출될 수 있으니, 도배성
              게시글보다는 양질의 내용을 작성해 주시기 바랍니다.
            </li>
            <li>현재는 디자인 작업 없이 기능 구현에 중점을 두었습니다.</li>
            <li>
              기타 버그사항 및 개선점 발견 시 제안사항 마이너 갤러리 (현재
              버그로 인해 작성불가, 추후 수정예정...)에 작성 부탁드립니다.
            </li>
          </ol>
        </TestNotice>
      </Main>
